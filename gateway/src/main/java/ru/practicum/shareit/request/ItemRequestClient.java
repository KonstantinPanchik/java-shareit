...
public class ItemRequestClient extends BaseClient {
    ...
    public ResponseEntity<Object> addRequest(ItemRequestCreationDto itemRequest, Long userId) {
    ...
    public ResponseEntity<Object> getRequestsNotCurrentUser(Integer from, Integer size, Long userId) {
