...
public class BookingMapper {
    ...
    public static Booking toBookingFromCreation(BookItemRequestDto bookItemRequestDto, User booker, Item item) {
        Booking booking = Booking.builder()
                .start(bookItemRequestDto.start)
                .end(bookItemRequestDto.end)
